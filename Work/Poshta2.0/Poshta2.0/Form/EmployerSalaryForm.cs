...
namespace Poshta2._0
{
    public partial class EmployerSalaryForm : Form
    {
        ...
        public void Suma()
        {
            object Sum;
            object SumIKP;
            SumIKP = Math.Round((double)dataTable.Compute("Sum(Salary_KPI)", string.Empty), 2);
            Sum = dataTable.Compute("Sum(Salary)", string.Empty);
        ...
        {
            dataTable.DefaultView.Sort = "Post DESC";
